...
namespace PavonisInteractive.TerraInvicta
{
    ...
    public class patch_TIFactionState : TIFactionState
    {
       ...
       public TIDateTime LastObjectiveProjectCompletionDate { get; private set; }
        ...
        //{
        //    orig_PostGlobalGameStateCreateInit_2();

        //    cachedBaseHabsMultipliers = new Dictionary<TechCategory, float>();
        //    baseHabsMultiplierCachedFrames = ((TechCategory[])Enum.GetValues(typeof(TechCategory))).ToDictionary(x => x, x => -1);
        //    cachedTraitsMultiplier = new Dictionary<TechCategory, float>();
        //    traitsMultiplierCachedFrame = Enums.TechCategories.ToDictionary((TechCategory x) => x, (TechCategory x) => -1);
        //    cachedOrgsMultiplier = new Dictionary<patch_TechCategory, float>();
        //    orgsMultiplierCachedFrame = Enums.TechCategories.ToDictionary((TechCategory x) => x, (TechCategory x) => -1);
        //    cachedFleetsModifier = new Dictionary<TechCategory, float>();
        //    fleetsModifierCachedFrame = Enums.TechCategories.ToDictionary((TechCategory x) => x, (TechCategory x) => -1);
        //    Log.Debug($"B {cachedOrgsMultiplier}");

        //}


        //public void SetResourceIncomeDataDirty(patch_FactionResource resource)
        //{
        //    this.resourceIncomeDataDirty[resource] = true;
        //    if (resource == (patch_FactionResource)FactionResource.MissionControl)
        //    {
        //        this.resourceIncomeDataDirty[(patch_FactionResource)FactionResource.Money] = true;
        //        this.resourceIncomeDataDirty[(patch_FactionResource)FactionResource.Research] = true;
        //    }
        ...
        //public void SetResourceIncomeDataDirty(patch_FactionResource[] resources)
        //{
        //    for (int i = 0; i < resources.Length; i++)
        //    {
        //        this.resourceIncomeDataDirty[resources[i]] = true;
        //        if (resources[i] == (patch_FactionResource)FactionResource.MissionControl)
        //        {
        //            this.resourceIncomeDataDirty[(patch_FactionResource)FactionResource.Money] = true;
        //            this.resourceIncomeDataDirty[(patch_FactionResource)FactionResource.Research] = true;
        //        }
        ...
        //{
        //    this.resourceIncomeDataDirty.Keys.ToList<patch_FactionResource>().ForEach(delegate (patch_FactionResource x)
        //    {
        //        this.resourceIncomeDataDirty[x] = true;
        //    });
        //    GameControl.eventManager.TriggerEvent(new FactionResourcesUpdated(this), null, new object[]
        //    {
        //        this
        ...
        //public void ChangeBaseResourceIncome(patch_FactionResource resourceType, float amount)
        //{
        //    if (resourceType != (patch_FactionResource)FactionResource.None)
        //    {
        //        Dictionary<patch_FactionResource, float> dictionary = this.baseIncomes_year;
